...
(function() {
    ...
    a = function() {
        ...
        return c.prototype.defaults = {
            ...
            var c, d, e;
            return d = a.getAttribute("data-wow-duration"), c = a.getAttribute("data-wow-delay"), e = a.getAttribute("data-wow-iteration"), this.customStyle(a, b, d, c, e)
        }, c.prototype.resetStyle = function() {
            var a, b, c, d, e;
            for (d = this.boxes, e = [], b = 0, c = d.length; c > b; b++) a = d[b], e.push(a.setAttribute("style", "visibility: visible;"));
            return e
        }, c.prototype.customStyle = function(a, b, c, d, e) {
            return b ? (a.style.visibility = "hidden", a.style["-webkit-animation-name"] = "none", a.style["animation-name"] = "none") : (a.style.visibility = "visible", a.style["-webkit-animation-name"] = window.getComputedStyle(a).getPropertyValue("webkitAnimationName"), a.style["animation-name"] = window.getComputedStyle(a).getPropertyValue("animationName")), c && (a.style["-webkit-animation-duration"] = c, a.style["-moz-animation-duration"] = c, a.style["animation-duration"] = c), d && (a.style["-webkit-animation-delay"] = d, a.style["-moz-animation-delay"] = d, a.style["animation-delay"] = d), e && (a.style["-webkit-animation-iteration-count"] = e, a.style["-moz-animation-iteration-count"] = e, a.style["animation-iteration-count"] = e), a
